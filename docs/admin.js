...
/**
  ...
  * 
  * @apiParam  {String} accountToken This is the account token generated by web/token endpoint
  * @apiParam  {String} code This code was sent as a get parameter in the reset link sent to the user's email ID
  ...
  */
  ...
  /**
  * 
  * @api {post} /admin/account_action To perform action on the user Accounts
  ...
  * @apiParam  {String} action The action number. 0-pending, 1-active, 2-blocked
  *
  * 
  * @apiParamExample  {type} Request-Example:
  *{
